...
- Odločili smo se, da bomo naredili priporočilno aplikacijo, kjer uporabnik vnese nekaj parametrov in glede na njih aplikacija prikaže ustrezno pot. Parametri naj bi bili: občina, dolžina poti, težavnost in podlaga. Pri podlagi se nam je zalomilo, podatke o tej smo hoteli pridobiti z OpenStreetMap, a za veliko večino segmentov smo dobili podatek "unknown", kar nam seveda ni prav nič pomagalo, zato smo ta parameter odstranili. Prav tako smo želeli kratke nepovezane segmente povezati z uporabo OpenStreetMap, kar je kazalo že dobro, a na koncu tudi ni delalo kot smo želeli, zato smo se odločili, da bo aplikacija delovala "filtrirno": uporabnik vnese občino, dolžino in težavnost in aplikacija mu izpiše in izriše vse segmente, ki temu ustrezajo, uporabnik pa se lahko nato odloči, kam natanko bo odšel kolesarit.
- Seveda pa uporabnik v aplikaciji lahko vidi tudi nekaj zanimivih vizualizacij glavnih ugotovitev, ki smo jih pridobili iz podatkov.

Na sliki na levi vidimo izbiro parametrov, na desni pa zemljevid s prikazanimi segmenti, ki so tudi našteti spodaj v tabelici.
...
KONCNO.md
8 KB
[22:51]vader: no kr je dodan je sam tola
[22:51]vader: Integracija slik s Komoota
...
Na sliki na levi vidimo izbiro parametrov, na desni pa zemljevid s prikazanimi segmenti, ki so tudi našteti spodaj v tabelici.
![alt text](image-6.png)
[23:30]jgrohar: a lohk sam probas zagnat app pa pogledas ce dela okej ( ni lih hitro ma moglo bi delat) sm dau zdej na PR17 in je app Kolesarjenje.py
﻿
vader
miginuy
